        ...
        <div className="w-full h-screen flex">
            <div className="w-3/5 flex flex-col items-center justify-center my-auto">
                ...
                <form action="" className='flex flex-col w-3/4 mx-auto font-worksans border-emascoklat border-2 py-12 p-2 rounded-lg items-center mb-8'>
                    <h2 className="text-2xl font-semibold mb-10 text-center">Reset Kata Sandi</h2>
                    {/* -- */}
                    <input type="email" placeholder='Email'className='max-w-sm'/>
                    <a href="/new-password" className='submit mt-8 text-center w-full max-w-sm rounded-xl px-6 py-3'>Berikutnya</a>
