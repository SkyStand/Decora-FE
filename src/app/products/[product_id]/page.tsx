...
import IProductDetails, {
  Variant,
} from "../../../../data/interface/response/IProductDetails";
  ...
  useEffect(() => {
    if (products) {
      ...
      const discountedPrice =
        ...
        (selectedVariant.price * (selectedVariant.diskon || 0)) / 100;
          ...
          <div className="mb-6 text-blue-tua">
            ...
            <div className="flex gap-2">
              {products.variants.map((variant, index) => (
                <div
                  key={index}
                  className={`w-11 h-11 rounded-lg border flex items-center justify-center cursor-pointer ${
                    index === selectedVariantIndex ? "border-blue-tua" : ""
                  }`}
